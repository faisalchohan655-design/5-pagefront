...
const LeadManager = () => {
  ...
  const stages = [
    ...
    { id: 'contacted', label: 'Contacted', icon: '📞', color: 'yellow' },
    { id: 'qualified', label: 'Qualified', icon: '✅', color: 'green' },
    { id: 'proposal', label: 'Proposal', icon: '📄', color: 'orange' },
    { id: 'closed', label: 'Closed', icon: '🏆', color: 'pink' },
  ];
                    ...
                    filteredLeads.map((lead) => {
                      ...
                      return (
                        <tr key={lead._id} className="border-t border-slate-700 hover:bg-slate-700/30 transition-colors">
                          ...
                          <td className="px-4 py-3">
                            <div className="flex items-center gap-2">
                              <button className="p-1 hover:bg-slate-600 rounded-lg">
